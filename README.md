...
This repo's code is written by following the "Full Screen Image Slider With HTML, CSS & JS" youtube video tutorials which is created by Sir Brad Traversy (Youtube Channel:Traversy Media). 
